          ...
          content: SizedBox(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  DialogField(controller: modelIdentCodeCtrl, label: 'Model Ident Code (e.g. MI171A3)'),
                  ...
                  DialogField(controller: techNameCtrl, label: 'Tech Name'),
                  DialogField(controller: partnerCodeCtrl, label: 'Partner Code'),
                  DialogField(controller: partnerNameCtrl, label: 'Partner Name'),
                  DialogField(controller: dataDistributionCtrl, label: 'Data Distribution'),
                  DialogField(controller: copyrightParaCtrl, label: 'Copyright Para'),
                  DialogField(controller: brexInfoCodeCtrl, label: 'BREX Info Code (e.g. 022)'),
                  DialogField(controller: brexLocationCtrl, label: 'BREX Location (e.g. D)'),
                ],
              ),
            ),
          ),
